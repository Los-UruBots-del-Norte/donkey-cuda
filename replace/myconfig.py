...
LEARNING_RATE = 0.002           #only used when OPTIMIZER specified
...
RANSFORMATIONS = []       # changes applied _before_ training augmentations,
...
RESIZE_HEIGHT = 480    # vertical size in pixels
# 
